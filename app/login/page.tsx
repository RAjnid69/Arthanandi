...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: "var(--background)" }}>
            {/* Background Blobs */}
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full opacity-20 blur-[120px] animate-pulse-glow" style={{ background: "var(--brand)" }} />
            <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full opacity-20 blur-[120px] animate-pulse-glow" style={{ background: "var(--accent)" }} />
                ...
                <div className="glass-panel p-8 md:p-10 border border-[var(--border-bright)] shadow-2xl">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-[var(--text-secondary)] text-sm">
                            Log in to access your trading intelligence
                        </p>
                    </div>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2 ml-1">
                                ...
                                <Link href="#" className="text-[10px] font-bold text-[var(--brand-light)] hover:underline">
                                    Forgot Password?
                                </Link>
                            </div>
                            <input
                    ...
                    <p className="text-center mt-10 text-sm text-[var(--text-muted)]">
                        ...
                        <Link href="/signup" className="font-bold text-[var(--brand-light)] hover:underline">
                            Create Account
                        </Link>
                    </p>
                </div>
